  ...
  const categories = [
    {
      ...
      categoryParam: "sarees", // This matches the category filter in Catalogs.tsx
    },
    {
      name: "Salwar Suits",
                    ...
                    <div className="text-white">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Button
                          ...
                          variant="outline"
                        >
                          {/* Fixed: Route to catalogs with category filter instead of search */}
                          <Link to={`/catalogs?cat=${category.categoryParam}`}>
                            Explore
